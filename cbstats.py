    ...
    def get_usage_stats(self):
        ...
        for line in lines:
            ...
            if match_connect:
                ...
                connected_log.append('{date} {time} {name} connected'.format( debug=groups, date=match_connect.group('date'), time=match_connect.group('time'), name=match_connect.group('user') ) )
                ...
                if match_disconnect:
                    ...
                    connected_log.append('{date} {time} {name} disconnected ({delta})'.format( date=match_disconnect.group('date'), time=match_disconnect.group('time'), name=match_disconnect.group('user'), delta=delta_format ) )
